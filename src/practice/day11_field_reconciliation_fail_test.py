# QueryForge
# Day 11 - Field-Level Reconciliation FAIL Test
...
try:
    ...
    # ========================================================
    # 9. DAY 11 PRACTICE ONLY
    # SIMULATE ONE GENUINE FIELD MISMATCH
    # ========================================================

    target_df.loc[
        target_df["customer_id"] == 4101,
        "city"
    ] = "Mumbai"

    print(
        "\nSIMULATION:"
        " Customer 4101 target city "
        "changed to Mumbai in Python memory."
    )


    # ========================================================
    # 10. MERGE SOURCE AND TARGET
    # ========================================================
    ...
    # ========================================================
    # 11. CHECK MISSING TARGET RECORDS
    # ========================================================
    ...
    # ========================================================
    # 15. DISPLAY FIELD MISMATCH DETAILS
    # ========================================================
