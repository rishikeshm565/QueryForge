...
# Add controlled duplicate and invalid records in memory
# ============================================================

duplicate_test_row = df.iloc[[0]].copy()

invalid_test_row = pd.DataFrame(
    [
        {
            "customer_id": 999999,
            ...
            "is_active": True,
            "date_of_birth": None,
            "notes": "Day 11 rejected-row test"
        }
    ]
)
...
print("\nTEST DATA ADDED:")
print("1 duplicate customer_id")
print("1 invalid record with missing email")
